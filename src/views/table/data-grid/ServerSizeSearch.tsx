...
import CallFilterApply from 'src/components/callReports/CallFilterApply'
import { useDateRangePicker } from 'src/views/form/form-element'
...
const ServerSideSearch = ({ onChange, filterType, onFilterType, resetFilterType, exportData }: Props) => {
