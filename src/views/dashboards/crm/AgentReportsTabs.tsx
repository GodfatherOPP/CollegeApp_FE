...
import { getDailyAgentOverview, getDashboardAgentOverview, getDashboardRouteTracker, getWeeklyAgentOverview } from 'src/store/dashboard'
...
const AgentReportsTabs = ({ title, subTitle }: Props) => {
  ...
  const dailyAgentOverview = useSelector((state: any) => state.dashboard.dailyAgentOverview)
  ...
  useEffect(() => {
    dispatch(getDailyAgentOverview())
  }, [])
  ...
  const setDashboardData = () => {
    setDetails([
      { label: "Total Calls", value: dailyAgentOverview?.routeData?.totalAgentCalls || 0 },
      { label: "Inbound", value: dailyAgentOverview?.routeData?.totalinBoundCalls || 0 },
      { label: "Outbound", value: dailyAgentOverview?.routeData?.totalOutboundCalls || 0 },
      { label: "PTP", value: dailyAgentOverview?.routeData?.totalPtp || 0 },
      { label: "Total Past Due", value: dailyAgentOverview?.routeData?.totalPastDueAccount || 0 }
    ])

    const tempCurrAcc = ((dailyAgentOverview?.routeData?.currentAccount / dailyAgentOverview?.routeData?.totalIdmsCustomer) * 100).toFixed()
    const tempfirstPastDueAccount = ((dailyAgentOverview?.routeData?.firstPastDueAccount / dailyAgentOverview?.routeData?.totalIdmsCustomer) * 100).toFixed()
    const tempsecondPastDueAccount = ((dailyAgentOverview?.routeData?.secondPastDueAccount / dailyAgentOverview?.routeData?.totalIdmsCustomer) * 100).toFixed()
    const tempthirstPastDueAccount = ((dailyAgentOverview?.routeData?.thirstPastDueAccount / dailyAgentOverview?.routeData?.totalIdmsCustomer) * 100).toFixed()
    const tempstarting = ((dailyAgentOverview?.routeData?.mondayCurrentAccount / dailyAgentOverview?.routeData?.totalIdmsCustomer) * 100).toFixed()
    ...
    setProgressData({
      firstPastDueAccount: dailyAgentOverview?.routeData?.firstPastDueAccount || 0,
      secondPastDueAccount: dailyAgentOverview?.routeData?.secondPastDueAccount || 0,
      thirstPastDueAccount: dailyAgentOverview?.routeData?.thirstPastDueAccount || 0,
      starting: dailyAgentOverview?.routeData?.mondayCurrentAccount || 0,
    })
    ...
    setOptions([
      {
        ...
        labels: [`1 - 15\n ( ${dailyAgentOverview?.routeData?.firstPastDueAccount || 0} )`, dailyAgentOverview?.routeData?.firstPastDueAccount],
        colors: [hexToRGBA('#C34A36', 1)],
        states: {
          hover: {
            filter: { type: 'none' }
      ...
      },
      {
        ...
        labels: [`16 - 30 ( ${dailyAgentOverview?.routeData?.secondPastDueAccount || 0} )`, dailyAgentOverview?.routeData?.firstPastDueAccount],
        colors: [hexToRGBA('#C34A36', 1)],
        states: {
          hover: {
            filter: { type: 'none' }
      ...
      },
      {
        ...
        labels: [`31+ ( ${dailyAgentOverview?.routeData?.thirstPastDueAccount || 0} )`, dailyAgentOverview?.routeData?.secondPastDueAccount],
        colors: [hexToRGBA('#C34A36', 1)],
        states: {
          hover: {
            filter: { type: 'none' }
      ...
      },
      {
        ...
        labels: [`Starting ( ${dailyAgentOverview?.routeData?.mondayCurrentAccount || 0} )`, dailyAgentOverview?.routeData?.thirstPastDueAccount],
        colors: [hexToRGBA('#C34A36', 1)],
        states: {
          hover: {
            filter: { type: 'none' }
      ...
      },
      {
        ...
        labels: ['Currents Account', dailyAgentOverview?.routeData?.currentAccount],
        colors: [hexToRGBA('#C34A36', 1)],
        states: {
          hover: {
            filter: { type: 'none' }
  ...
  useEffect(() => {
    ...
    const filterData = dailyAgentOverview?.data
      ?.map((item: any) => {
...
export default AgentReportsTabs
